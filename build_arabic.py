...
AR_TITLES = {
    ...
    "b2b.html": "منتجات للأعمال | نكهات وبهارات وصوصات — تقوى للأغذية",
...
AR_DESCRIPTIONS = {
    ...
    "b2b.html":
        "نكهات وتوابل مشكلة وصوصات وبهارات وجبات سريعة نصنّعها لشركات الأغذية "
        "والمطاعم وعملاء العلامة الخاصة.",
    "our-brands/flavora-cafe.html":
